...
<div class="container">
  ...
  <div class="row pretraga_vesti">
    <div class="col-lg-6">
      <h1 style="color: maroon">Opis vesti</h1>
    ...
    <div class="col-lg-6">
      ...
      <?php 
       ...
       <div class="well" style="background-color: maroon">
        ...
        <input type="submit" id="submit" name="submit" class="btn btn-secondary btn-block" onclick = "dodajKomentar();" value="Postavi komentar">
       </div>
    </div>
  </div>
  </div>
